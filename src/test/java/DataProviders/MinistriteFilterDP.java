...
public class MinistriteFilterDP {
    @DataProvider(name = "ministriaTypes")
    public Object[][] getServiceTypes() throws IOException {
        String filePath = "C:\\Users\\Arbi.topi\\IdeaProjects\\TestimTemp\\ExcelFiles\\Ministrite.xlsx";  // Change this path
