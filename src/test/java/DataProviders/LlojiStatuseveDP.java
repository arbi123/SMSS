...
public class LlojiStatuseveDP {
    @DataProvider(name = "statusTypes")
    public Object[][] getServiceTypes() throws IOException {
        String filePath = "C:\\Users\\Arbi.topi\\IdeaProjects\\TestimTemp\\ExcelFiles\\Statusi Sherbimit.xlsx";  // Change this path
